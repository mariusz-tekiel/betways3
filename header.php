				...
				<div class="collapse navbar-collapse" id="mainmenu">
					<ul class="navbar-nav mr-auto">
					  ...
					  <li class="nav-item dropdown <?php echo $horseRacing ?>">
							...
							<div class="dropdown-menu" aria-labelledby="submenu">
								<a class="dropdown-item" href="horse-racing-fibonacci-system">Fibonacci</a>
								<a class="dropdown-item" href="horse-form-last-ran"> Form Last Ran</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="horse-lay-the-loser"> Lay The Loser</a>
								<a class="dropdown-item" href="horse-racing-favourite">2nd/3rd Favourite</a>
							</div>
						</li>
					  ...
					  <li class="nav-item dropdown <?php echo $tennis ?>">
							...
							<div class="dropdown-menu" aria-labelledby="submenu">
								<a class="dropdown-item" href="tennis-betting-strategy-favourite">Favourite</a>
								<a class="dropdown-item" href="tennis-betting-strategy-fortune">Fortune for Tennis</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="tennis-follow-the-server"> Follow the Server</a>
								<a class="dropdown-item" href="tennis-catch-break-point">Catch the Break Point</a>
							</div>
						</li>
