...
function sprawdz(nr){
	...
	//Loss
	if (attemptCounter>=9){	
		document.getElementById("alfabet").innerHTML = "You lost!  The right password was: " + '<h3 style="color:red;">' +pass+ '</h3>' + '</br></br><span class="reset" onclick="location.reload()">PLAY AGAING</span>';
